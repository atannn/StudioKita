<x-owner-layout title="Tambah Service">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select name="tipe_service"
                                    class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500"
                                    required>
                                <option value="latihan" @selected(old('tipe_service')==='latihan')>latihan</option>
                                <option value="rekaman" @selected(old('tipe_service')==='rekaman')>rekaman</option>
                            </select>
                        </div>
